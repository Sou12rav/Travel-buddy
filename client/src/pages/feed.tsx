...
export default function Feed() {
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-16 px-4">
      <header className="sticky top-0 bg-white pt-4 pb-2 z-10">
        <h1 className="font-poppins font-semibold text-xl text-dark">Explore</h1>
      </header>
      ...
      {posts.length > 0 ? (
        ...
        <div className="flex-1 flex items-center justify-center h-[400px]">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400">Follow more users to see their travel updates</p>
          </div>
        </div>
      )}
